...
import (
	...
	"github.com/DazzlingSun/monitorService/src/basic/net/rpc/liverpc/testdata/v1"
	"github.com/DazzlingSun/monitorService/src/basic/net/rpc/liverpc/testdata/v2"
)
